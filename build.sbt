...
libraryDependencies += "org.apache.spark" % "spark-launcher_2.11" % "2.2.0"
libraryDependencies += "org.apache.spark" % "spark-network-shuffle_2.11" % "2.2.0"
...
libraryDependencies += "com.mchange" % "c3p0" % "0.9.5.3"
